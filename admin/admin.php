...
<br>
<br>
<h4 style="margin-top: 20px;"class="text-center "><b>SMK MERDEKA BANDUNG</b>  </h4>
    <div class="container mt-5">
        ...
        <a onclick="alert('Apakah Anda Yakin Akan Logout?')"href="admin.php?url=logout" class="btn btn-danger" >Logout</a>
        <div class="card mt-2 alert alert-info">
            <div class="card-body">
                ...
                $file = @$_GET['url'];
                if(empty($file)){
                    echo"<h4>Hello Administrator.</h4>";
